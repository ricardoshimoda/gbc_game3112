...
void ATPSPlayer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("PickupInvincibility", IE_Pressed, this, &ATPSPlayer::PickUpInvincible);
	PlayerInputComponent->BindAction("PickupMegaDamage", IE_Pressed, this, &ATPSPlayer::PickUpDamager);
}
